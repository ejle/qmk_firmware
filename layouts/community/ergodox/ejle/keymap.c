 ...
 * |`       |   Q  |   W  |   E  |   R  |   T  |  {   |           |  }   |   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |tab     |   A  |   S  |   D  |F/MDIA|   G  |------|           |------|   H  |J/MDIA|   K  |   L  |   ;  |'       |
 * |--------+------+------+------+------+------|  [   |           |   ]  |------+------+------+------+------+--------|
 * | LS/PO  |   Z  |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |   /  | RS/PC  |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  ctl |      |      |  gui | alt  |                                       |   alt| left | down |   up | right|
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        | ~L8  |   L7 |       | L0   |  ~L8   |
 *                                 ,------|------|------|       |------+--------+------.
 ...
 * | LS/PO  |   Z  |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |   /  | RS/PC  |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  ctl |      |      |  alt | gui  |                                       |   gui| left | down |   up | right|
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        | ~L8  |   L7 |       | L0   |  ~L8   |
 *                                 ,------|------|------|       |------+--------+------.
...
// If it accepts an argument (i.e, is a function), it doesn't need KC_.
// Otherwise, it needs KC_*
[FULL_MAC] = LAYOUT_ergodox(  // layer 0 : default
        // left hand
        KC_GRV,  KC_1,  KC_2,  KC_3,    KC_4,                KC_5, KC_MINS,
        KC_GRV,  KC_Q,  KC_W,  KC_E,    KC_R,                KC_T, KC_LCBR,
        KC_TAB,  KC_A,  KC_S,  KC_D,    LT(FULL_MDIA, KC_F), KC_G,
